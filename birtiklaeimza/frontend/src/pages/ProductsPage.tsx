...
const fallbackProducts: Product[] = [
  {
    ...
    longDescription: 'Türkiye\'de yasal geçerliliği olan, Akredite CA/Nitelikli CA tarafından onaylı nitelikli elektronik imza (NES) sertifikası. E-devlet işlemleri, sözleşmeler ve tüm resmi belgeler için kullanabilirsiniz. USB Token dahildir, sürücü kurulumu ve aktivasyon desteği ücretsiz sağlanır.',
    price: 299,
    originalPrice: 399,
    category: 'Bireysel',
  ...
  },
  {
    ...
    price: 349,
    category: 'Mobil',
    features: ['1 Yıl Geçerlilik', 'SIM Kart Tabanlı', 'Token Gerekmez', 'Mobil Uyumlu', 'Nitelikli Onaylı'],
    validityYears: 1,
    tokenType: 'SIM Kart',
  },
  {
    ...
    originalPrice: 899,
    category: 'Mobil',
    features: ['3 Yıl Geçerlilik', 'SIM Kart Tabanlı', 'Token Gerekmez', 'Mobil Uyumlu', 'Nitelikli Onaylı'],
    validityYears: 3,
    tokenType: 'SIM Kart',
  },
]
