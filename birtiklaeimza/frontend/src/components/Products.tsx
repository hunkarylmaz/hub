...
export default function Products() {
  ...
  return (
    <section className="py-12 md:py-20 lg:py-24 bg-slate-50" id="urunler">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filter Tabs */}
        <div className="flex overflow-x-auto pb-2 sm:flex-wrap sm:justify-center gap-2 mb-8 scrollbar-none -mx-4 px-4 sm:mx-0 sm:px-0">
          {FILTER_TABS.map((tab) => (
            <button
              key={tab.key}
